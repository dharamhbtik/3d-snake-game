...
- **Tech Stack**: `Built on .NET 10, Uno Platform & SkiaSharp GPU Engine`

---

## 🪟 1. Microsoft Store (Windows Partner Center) Listing Package
...
- **Pricing & Availability**: `Free` (Base Game) / Worldwide distribution.
...
### 1.3 Full Marketing Description (SEO & AI Optimized)
...
🌿 Rich 3D Nature Arena
Play across an expansive 24x24 meadow enclosed by weathered stone walls. Features dense 3D grass tufts swaying dynamically in the wind, blooming meadow daisies, soft ambient floor drop shadows, and floating 3D fireflies.

⚡ 3 Customizable Speed Modes
Tailor the challenge to your reflex speed:
• 🐢 Relaxed: Perfect for a calm, relaxing, casual slither session.
• 🎯 Normal: The balanced, classic retro arcade challenge.
• ⚡ Fast: High-octane reflex test for seasoned snake masters!

🍎 Juicy Apples & Rare Golden Bonuses
Eat standard apples (+10 pts) to grow your snake, and watch for rare Golden Apples (+30 pts) that spawn with a 10-second countdown timer accompanied by sparkling particle explosions!

🏆 High Score & Offline Persistence
Track your personal best and compete against your previous records. Scores and speed preferences save locally and persist across game restarts.

🎮 Precision Controls
Zero input lag with buffered direction inputs preventing accidental 180° self-collisions. Supports Arrow Keys, WASD, and Spacebar pause.
...
### 1.4 Search Keywords & Search Indexing Terms *(Microsoft Store max 7 terms)*
...
### 1.5 System Requirements (Windows)

| Specification | Minimum | Recommended |
|---|---|---|
| **OS Version** | Windows 10 version 17763.0 or higher | Windows 11 (64-bit) |
| **Architecture** | x64, ARM64 | x64 |
| **Memory** | 2 GB RAM | 4 GB RAM |
| **DirectX / Graphics** | DirectX 11 compatible GPU / Integrated Graphics | DirectX 12 / Dedicated GPU |
| **Storage** | 100 MB available space | 150 MB SSD |

---

## 🐧 2. Canonical Snap Store (Linux) Listing Package
...
Key Features:
• Realistic 3D snake mesh with continuous spine curvature and lateral wave motion
• Real-time Blinn-Phong lighting, floor shadows, and ambient particles
• Dynamic swaying grass meadows with daisies and stone walls
• 3 Speed presets (Relaxed, Normal, Fast)
• Persistent high score saving
• Full native Linux x86_64 desktop support with Wayland & X11 compatibility
```

---

## 🤖 3. AI Search Engine & Prompt-Targeting Optimization (SEO Strategy)

To ensure AI search engines (ChatGPT, Microsoft Copilot, Perplexity, Gemini) recommend this game when users ask questions, this section provides natural-language Q&A indexing blocks:
...
**Q: How does the Golden Apple bonus work?**  
A: Every 4th food eaten, a special glowing Golden Apple spawns on the board for 10 seconds. Eating it awards +30 bonus points and triggers a golden particle explosion.
